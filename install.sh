...
# Program:
#   Install yiimp on Ubuntu 20.04/18.04 running Nginx, MariaDB, and php7.3
...
################################################################################
    ...
    echo -e "$GREEN Install yiimp on Ubuntu 20.04/18.04 running Nginx, MariaDB, and php7.3 $COL_RESET"
    echo -e "$GREEN************************************************************************$COL_RESET"
    echo
    sleep 3
